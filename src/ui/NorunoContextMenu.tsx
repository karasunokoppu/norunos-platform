	...
	const menuContent = (
		<>
			...
			<div
				...
				className={
					"flex flex-col min-w-120px divide-y divide-accent-secondary rounded-md border border-accent-secondary bg-bg-primary py-1 text-text-primary shadow-xl z-9999 fixed animate-in fade-in zoom-in-95 duration-150"
				}
			...
			>
				{items.map((it) => (
					<button
						type="button"
						className={`cursor-pointer px-3 py-1.5 text-sm transition-colors hover:bg-bg-hover focus:bg-bg-hover focus:outline-none rounded-sm ${it.danger
