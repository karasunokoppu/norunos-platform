    ...
    return (
        <div>
            ...
            >
                ...
                <Folder size={14} className={`mr-2 ${isSelected ? "text-white" : "text-accent-secondary"}`} />
...
const FolderSelectDialog: React.FC<FolderSelectDialogProps> = ({ isOpen, folders, onSelect, onCancel }) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-bg-primary border border-border-primary w-96 max-h-[80vh] flex flex-col rounded shadow-lg">
                ...
                <div className="flex-1 overflow-y-auto p-2">
                    ...
                    >
                        <Folder size={14} className={`mr-2 ${selectedPath === "" ? "text-white" : "text-accent-secondary"}`} />
                        <span>Root (/)</span>
                    </div>
