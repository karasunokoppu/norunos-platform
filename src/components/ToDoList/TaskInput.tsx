...
const TaskInput: React.FC<TaskInputProps> = () => {
	...
	const buttonCss =
		"bg-accent-primary text-text-on-accent hover:bg-accent-hover px-4 py-2 rounded-md font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-accent-secondary";
	const inputCss =
				...
				<div className="border-t border-border-primary bg-bg-secondary p-4 animate-in slide-in-from-top-2 duration-300">
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
						<div className={datePickerContainer}>
							<label className="text-text-primary font-medium text-sm">開始日:</label>
							<button className={`${inputCss} w-full text-left`} onClick={() => setIsSDPOpen(true)}>
						...
						<div className={datePickerContainer}>
							<label className="text-text-primary font-medium text-sm">終了日:</label>
							<button className={`${inputCss} w-full text-left`} onClick={() => setIsEDPOpen(true)}>
					...
					<div className="mb-4">
						<label className="text-text-primary font-medium text-sm block mb-2">グループ:</label>
						<NorunoDropdown
							value={taskGroup}
					...
					<div className="flex justify-center">
						<button
							...
							className="text-text-secondary hover:text-text-primary px-4 py-2 rounded-md hover:bg-bg-hover transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-accent-secondary"
						>
